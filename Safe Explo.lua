...
local AOE = {
    ...
    if_mana_under = 400                                         -- don't use explo if mana equal or above this value. Put 99999 to ignore  
}
...
function safeExplo(monsters)
    ...
    -- when self mana is above value return false
    if Self.Mana() >= AOE.if_mana_under then return false end
